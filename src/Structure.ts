...
export function isConstructionSiteForStructure<T extends BuildableStructureConstant>(
	s: any, structureType: T
): s is ConstructionSite<T> {
	return s.structureType === structureType;
}
...
export function filterStructureType<T extends StructureConstant>(
	structures: AnyStructure[], type: T
): ConcreteStructure<T>[] {
...
export function isExtension(s: any): s is StructureExtension {
